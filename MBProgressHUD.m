...
- (void)layoutSubviews {
    ...
    NSDictionary *attributesDictionary = [NSDictionary dictionaryWithObjectsAndKeys:
                                          [UIFont fontWithName:@"AvenirNext-Regular" size:15], NSFontAttributeName,
                                          nil];
    CGSize labelSize = [label.text sizeWithAttributes:attributesDictionary];
    ...
    NSDictionary *attributes2 = [NSDictionary dictionaryWithObjectsAndKeys:
                                 [UIFont fontWithName:@"AvenirNext-Regular" size:15], NSFontAttributeName,
                                 nil];
    CGSize detailsLabelSize = [detailsLabel.text sizeWithAttributes:attributes2];
